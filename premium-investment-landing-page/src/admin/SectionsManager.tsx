...
export function SectionsManager({
  ...
  return (
    <div className="max-w-xl">
      <h2 className="font-display text-2xl font-semibold tracking-[-0.02em] text-[#1d1d1f]">Page sections</h2>
        ...
        {[...sections]
          ...
          .map((section) => (
            <label
              ...
              className="flex cursor-pointer items-center justify-between py-4 text-sm text-[#1d1d1f]"
            >
              {section.label}
              <input
                type="checkbox"
